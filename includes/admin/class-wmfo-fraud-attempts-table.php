 ...
 */
class WMFO_Fraud_Attempts_Table extends WP_List_Table {
	/**
	 * Prepare the items for the table to process
	 *
	 * @return Void
	 */
	protected $table = 'wmfo_fraud_attempts';
	...
	public function no_items() {
		_e( 'No fraud attempts records available.', 'woo-manage-fraud-orders' );
	}
	...
	public function delete_fraud_record( $id ) {
		$log_handler = new WMFO_Fraud_Attempts_DB_Handler();
