...
describe('BlacklistsTests for email', () => {
    beforeAll(async () => {
    ...
    it('should block email address john.doe@example.com', async () => {
        ...
        // 172.22.0.1
        await expect(page).toFill('#wmfo_black_list_emails', 'john.doe@example.com');
